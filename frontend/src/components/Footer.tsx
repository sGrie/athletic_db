...
function Footer() {
  return (
    <div className='bg-adb-blue-950 pt-8 pb-8 pl-4 pr-4 flex justify-center items-start flex-wrap gap-4 text-white'>
      <div className='basis-[350px] flex flex-col gap-2'>
